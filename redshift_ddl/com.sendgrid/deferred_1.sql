...
CREATE TABLE IF NOT EXISTS atomic.com_sendgrid_deferred_1 (
    ...
    "attempt"        VARCHAR(4096) ENCODE LZO,
    "category"       VARCHAR(4096) ENCODE LZO,
    "email"          VARCHAR(4096) ENCODE LZO,
    "response"       VARCHAR(4096) ENCODE LZO,
...
COMMENT ON TABLE atomic.com_sendgrid_deferred_1 IS 'iglu:com.sendgrid/deferred/jsonschema/1-0-0';
