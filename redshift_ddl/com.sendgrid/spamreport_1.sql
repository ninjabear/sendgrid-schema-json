...
CREATE TABLE IF NOT EXISTS atomic.com_sendgrid_spamreport_1 (
...
COMMENT ON TABLE atomic.com_sendgrid_spamreport_1 IS 'iglu:com.sendgrid/spamreport/jsonschema/1-0-0';
