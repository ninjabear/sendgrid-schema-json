...
CREATE TABLE IF NOT EXISTS atomic.com_sendgrid_delivered_1 (
...
COMMENT ON TABLE atomic.com_sendgrid_delivered_1 IS 'iglu:com.sendgrid/delivered/jsonschema/1-0-0';
