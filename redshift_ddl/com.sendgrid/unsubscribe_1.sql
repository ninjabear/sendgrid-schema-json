...
CREATE TABLE IF NOT EXISTS atomic.com_sendgrid_unsubscribe_1 (
...
COMMENT ON TABLE atomic.com_sendgrid_unsubscribe_1 IS 'iglu:com.sendgrid/unsubscribe/jsonschema/1-0-0';
