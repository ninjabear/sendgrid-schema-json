...
CREATE TABLE IF NOT EXISTS atomic.com_sendgrid_group_unsubscribe_1 (
...
COMMENT ON TABLE atomic.com_sendgrid_group_unsubscribe_1 IS 'iglu:com.sendgrid/group_unsubscribe/jsonschema/1-0-0';
